...
export default {
  ...
  methods: {
    ...
    getTimeHTML(distance) {
      ...
      if (bycicleTime > 60) {
        bycicleHour =
          '<span class="number small font-weight-bold">' +
      ...
      var content =
        '<ul style="list-style:none; color:black; font-weight: bold; background-color: #FFAE0099;border-radius: 10px;" class="dotOverlay distanceInfo small">';
      content += "    <li>";
      content +=
        '        <span class="label small font-weight-bold">거리</span><span class="number small font-weight-bold">' +
        distance +
        "</span>m";
      content += "    </li>";
      content += "    <li>";
      content +=
        '        <span class="label small font-weight-bold">도보</span>' +
        walkHour +
        walkMin;
      content += "    </li>";
      content += "    <li>";
      content +=
        '        <span class="label small font-weight-bold">자전거</span>' +
        bycicleHour +
        bycicleMin;
      content += "    </li>";
      content += "    <li>";
      content +=
        '        <span class="label small font-weight-bold">차</span>' +
        carHour +
        carMin;
      content += "    </li>";
      content += "</ul>";
